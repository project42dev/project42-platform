...
Expected learner action: Separate schema, semantic, authorization, approval, idempotency, and postcondition controls.
...
Expected learner action: Object-level authorization rejects the action regardless of schema validity or model recommendation.
...
Correct feedback: You separated a valid shape from permission on the resolved object.

Retry feedback: Ask who authenticated, which exact object was resolved, and where the policy grants that principal the requested operation.
