...
export function changedInput() {
  return {
    ...
    context:{
      ...
      approval:{approvalId:'approval_beta_1',actorId:'actor_learner',tenantId:'tenant_beta',action:'update_ticket_status',resourceId:'ticket_87654321',toStatus:'RESOLVED',expectedVersion:4,operationKey:'op_beta_resolve_0001'},
