...
Expected learner action: Define explicit completion, non-progress, budget, approval, and handoff boundaries for one agentic run.
...
Expected learner action: Stop on repeated non-progress, preserve the trajectory, report the missing evidence, and hand off or attempt only an authorized materially different recovery.
...
Correct feedback: You stopped repeated non-progress before budget exhaustion and preserved enough evidence for a useful handoff or different recovery.
