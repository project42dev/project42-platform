...
Package: `prompt-anatomy-and-success-criteria-class` 1.2.0
...
Expected learner action: Write two inspectable requirements and one non-blocking style preference.
...
Expected learner action: Write the six-heading changed-input response, calculate $600 minus $600 and $800 minus $600, preserve the Venue B conflict, and list checks to rerun.
