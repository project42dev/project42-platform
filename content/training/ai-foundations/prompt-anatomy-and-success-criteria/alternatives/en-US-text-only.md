...
Learner action: Write two inspectable requirements, such as comparing the same supported criteria with cited evidence, plus one non-blocking style preference.
