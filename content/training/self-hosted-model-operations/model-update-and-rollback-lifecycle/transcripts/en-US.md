...
Package: `model-update-and-rollback-lifecycle-class` 1.0.0
...
Expected learner action: Stop candidate exposure, preserve exact routing and failure evidence, restore or retain the approved baseline, reconcile affected work, and require authorized review before any revised release.
...
Correct feedback: You honored the hard gates, stopped exposure, preserved evidence, and restored the approved baseline.
