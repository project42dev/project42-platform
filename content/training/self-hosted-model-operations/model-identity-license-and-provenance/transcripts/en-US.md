# Know Exactly Which Model You Are Allowed to Operate

Package: `model-identity-license-and-provenance-class` 1.0.0
...
Correct feedback: You limited the claim to observed access and kept redistribution and Open Source status pending exact evidence.
...
Expected learner action: Complete the identity tuple, terms matrix, lineage map, evidence labels, bounded disposition, reviewer boundaries, and re-review triggers.
