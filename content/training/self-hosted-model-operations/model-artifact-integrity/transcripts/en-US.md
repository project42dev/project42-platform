# Move Model Artifacts from Quarantine to Trusted Service

Package: `model-artifact-integrity-class` 1.0.0
...
Expected learner action: State that the bytes match the expected digest and name unproven claims such as publisher identity, license, provenance, safety, or quality.
...
Retry feedback: Replace the broad word trusted with the exact property a digest can prove.
